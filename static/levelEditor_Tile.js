export class Tile {
    ...
    init() {
        ...
        this.img1.style.backgroundImage = "url('/media/tileset.png')"
        ...
        this.img2.style.backgroundImage = "url('/media/tileset.png')"
        ...
        this.img3.style.backgroundImage = "url('/media/tileset.png')"
